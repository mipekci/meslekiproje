      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a href="<?php echo base_url("show/users")?>" class="collapse-item">Kullanıcıları görüntüle</a>
            <a href="<?php echo base_url("show/appointments")?>" class="collapse-item">Randevuları görüntüle</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
